...
#sentence = ["The", "lead", "is", "heavy" ]
sentence = ["I", "will", "lead", "us" ]
...
# Lead?  
tagSentence("I will lead us to victory")
nltk.help.upenn_tagset('VB')
tagSentence("My backpack is as heavy as lead")
nltk.help.upenn_tagset('NN')


# Cool?
tagSentence("This is a cool example")
nltk.help.upenn_tagset('JJ')
tagSentence("You should let the tea cool down")
nltk.help.upenn_tagset('VB')


# Rare words are a problem
tagSentence("But your brain is no match for my Tractorbeam")
nltk.help.upenn_tagset('DO')
